        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: '#047857' }}>
                <span className="text-white text-xl font-bold">BJ</span>
              </div>
              <span className="ml-2 text-xl font-semibold text-gray-900">BecakJogja</span>
            </Link>
          </div>
          
          <div className="hidden sm:flex sm:items-center sm:space-x-4">
            <Link to="/" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-[#047857] transition-colors">
              Beranda
            </Link>
            <Link to="/pesan" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-[#047857] transition-colors">
              Pesan
            </Link>
          ...
          <div className="flex items-center sm:hidden">
            <button 
              ...
              className="p-2 rounded-md text-gray-700 hover:text-[#047857] focus:outline-none transition-colors"
            >
